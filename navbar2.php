...
body {
  ...
  background: radial-gradient(circle,rgb(104, 154, 248) 0%, #f0f0f0 100%);
  background-image: repeating-linear-gradient(
      0deg,
      rgba(188, 33, 33, 0.1) 0px,
...
<a class="navbar-brand" href="index.php" style="margin-left: 150px;">EduHub</a>
